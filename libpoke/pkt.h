...
#define pk_term_rgb_to_color libpoke_term_if.rgb_to_color
#define pk_term_get_color libpoke_term_if.get_color
#define pk_term_set_color libpoke_term_if.set_color
#define pk_term_get_bgcolor libpoke_term_if.get_bgcolor
#define pk_term_set_bgcolor libpoke_term_if.set_bgcolor
