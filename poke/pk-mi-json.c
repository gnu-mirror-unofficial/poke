  ...
  if  (!(pk_uint_value (pk_integral_type_signed_p (pk_typeof (integer)))))
    {
      ...
      value_object = json_object_new_int64 ((int64_t) pk_uint_value (integer));
...
pk_mi_struct_to_json (pk_val sct, char **errmsg)
{
  ...
  for (ssize_t i = 0 ; i < pk_uint_value (pk_struct_nfields (sct)) ; i++)
    {
      ...
      json_object_object_add (pk_struct_field_object, "name",
  ...
  json_object_object_add (pk_struct_object, "type", pk_struct_type_object);
  json_object_object_add (pk_struct_object, "name", pk_struct_name_object);
  json_object_object_add (pk_struct_object, "fields", pk_struct_fields_object);
  json_object_object_add (pk_struct_object, "mapping", pk_struct_mapping_object);
...
pk_mi_json_to_val (pk_val *value, const char *poke_object_str, char **errmsg)
{
  ...
  err = json_object_object_get_ex (poke_object, "PokeValue",
                                             &search_object);
