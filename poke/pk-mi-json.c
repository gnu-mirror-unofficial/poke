...
static json_object *pk_mi_struct_to_json (pk_val sct, char **errmsg);
static json_object *pk_mi_array_to_json (pk_val array, char **errmsg);

static json_object *
pk_mi_int_to_json (pk_val integer, char **errmsg)
{
  ...
  if  (!(pk_uint_value (pk_integral_type_signed_p (pk_typeof (integer)))))
    ...
    {
      value_object = json_object_new_int64 (pk_int_value (integer));
      PK_MI_CHECK (errmsg, value_object != NULL,
                  "json_object_new_object () failed");
  ...
  PK_MI_CHECK (errmsg,
              ...
              "json_object_object_add () failed");
  PK_MI_CHECK (errmsg,
              json_object_object_add (int_object, "value", value_object) != -1,
              "json_object_object_add () failed");
  PK_MI_CHECK (errmsg,
              json_object_object_add (int_object, "size", size_object) != -1,
              "json_object_object_add () failed");
...
static json_object *
pk_mi_string_to_json (pk_val str, char **errmsg)
{
  ...
  string_value_object = json_object_new_string (pk_string_str (str));
  PK_MI_CHECK (errmsg, string_value_object != NULL,
              "json_object_new_object () failed");

  /* OK, fill the properties of our object.  */
  err = json_object_object_add (string_object, "type", string_type_object);
  PK_MI_CHECK (errmsg, err != -1, "json_object_object_add () failed");

  err = json_object_object_add (string_object, "value", string_value_object);
  PK_MI_CHECK (errmsg, err != -1, "json_object_object_add () failed");
...
static json_object *
pk_mi_offset_to_json (pk_val offset, char **errmsg)
{
  ...
  struct json_object *unit_value_object;
  pk_val off_unit;
  int err;
  ...
  magnitude_object = pk_mi_int_to_json (pk_offset_magnitude (offset), errmsg);
  ...
  off_unit = pk_offset_unit (offset);
  unit_value_object = json_object_new_uint64 (pk_uint_value (off_unit));
  ...
  err = json_object_object_add (unit_object, "type", unit_type_object);
  PK_MI_CHECK (errmsg, err != -1, "json_object_object_add () failed");

  err = json_object_object_add (unit_object, "value", unit_value_object);
  PK_MI_CHECK (errmsg, err != -1, "json_object_object_add () failed");

  err = json_object_object_add (unit_object, "size", unit_size_object);
  PK_MI_CHECK (errmsg, err != -1, "json_object_object_add () failed");
  ...
  err = json_object_object_add (offset_object, "type", offset_type_object);
  PK_MI_CHECK (errmsg, err != -1, "json_object_object_add () failed");

  err = json_object_object_add (offset_object, "magnitude", magnitude_object);
  PK_MI_CHECK (errmsg, err != -1, "json_object_object_add () failed");

  err = json_object_object_add (offset_object, "unit", unit_object);
  PK_MI_CHECK (errmsg, err != -1, "json_object_object_add () failed");
...
pk_mi_mapping_to_json (pk_val val, char **errmsg)
{
  ...
  err = json_object_object_add (mapping_object, "IOS", ios_object);
  PK_MI_CHECK (errmsg, err != -1, "json_object_object_add () failed");

  err = json_object_object_add (mapping_object, "offset", offset_object);
  PK_MI_CHECK (errmsg, err != -1, "json_object_object_add () failed");
...
pk_mi_null_to_json (char **errmsg)
{
  ...
  err = json_object_object_add (pk_null_object, "type",
                                     json_object_new_string ("Null"));
  PK_MI_CHECK (errmsg, err != -1,
               "json_object_object_add () failed");

  err = json_object_object_add (pk_null_object, "value",
  ...
  if  (val == PK_NULL) {
    ...
    switch (pk_type_code (pk_typeof (val))) {
      ...
      case PK_OFFSET:
        ...
        break;
      case PK_STRUCT:
        pk_val_object = pk_mi_struct_to_json (val, errmsg);
        break;
      case PK_ARRAY:
...
static json_object *
pk_mi_struct_to_json (pk_val sct, char **errmsg)
{
  struct json_object *pk_struct_object, *pk_struct_type_object;
  struct json_object *pk_struct_fields_object, *pk_struct_field_object;
  struct json_object *pk_struct_mapping_object, *pk_struct_name_object;
  struct json_object *pk_struct_field_value_object;
  struct json_object *pk_struct_field_offset_object;
  struct json_object *pk_struct_field_name_object;
  pk_val tmp;
  int err;

  assert (pk_type_code (pk_typeof (sct)) == PK_STRUCT);

  pk_struct_type_object = json_object_new_string ("Struct");
  PK_MI_CHECK (errmsg, pk_struct_type_object != NULL,
               "json_object_new_object () failed");

  pk_struct_fields_object = json_object_new_array ();
  PK_MI_CHECK (errmsg, pk_struct_fields_object != NULL,
               "json_object_new_object () failed");

  /* Get the name of the struct type and convert it to JSON object.  */
  tmp = pk_struct_type (sct);
  pk_struct_name_object = pk_mi_val_to_json_1 (pk_struct_type_name (tmp), errmsg);
  PK_MI_CHECK (errmsg, pk_struct_name_object != NULL,
               "json_object_new_object () failed");

  /* Fill the array of struct fields.  */
  for (ssize_t i = 0 ; i < pk_uint_value (pk_struct_nfields (sct)) ; i++)
    {
      tmp = pk_struct_field_value (sct, i);
      pk_struct_field_value_object = pk_mi_val_to_json_1 (tmp, errmsg);
      tmp = pk_struct_field_boffset (sct, i);
      pk_struct_field_offset_object = pk_mi_offset_to_json (tmp, errmsg);
      tmp = pk_struct_field_name (sct, i);
      pk_struct_field_name_object = pk_mi_string_to_json (tmp, errmsg);

      if (pk_struct_field_value_object == NULL
          || pk_struct_field_offset_object == NULL
          || pk_struct_field_name_object == NULL)
            goto error;

      pk_struct_field_object = json_object_new_object ();

      err = json_object_object_add (pk_struct_field_object, "name",
                                         pk_struct_field_name_object);
      PK_MI_CHECK (errmsg, err != -1, "json_object_object_add () failed");

      err = json_object_object_add (pk_struct_field_object, "value",
                                         pk_struct_field_value_object);
      PK_MI_CHECK (errmsg, err != -1, "json_object_object_add () failed");

      err = json_object_object_add (pk_struct_field_object, "offset",
                                         pk_struct_field_offset_object);
      PK_MI_CHECK (errmsg, err != -1, "json_object_object_add () failed");

      err = json_object_array_add (pk_struct_fields_object,
  ...
  pk_struct_mapping_object = pk_val_mapped_p (sct) ?
                            pk_mi_mapping_to_json (sct, errmsg) :
                            pk_mi_null_to_json (errmsg);

  pk_struct_object = json_object_new_object ();
  PK_MI_CHECK (errmsg, pk_struct_object != NULL,
              "json_object_new_object () failed");

  err = json_object_object_add (pk_struct_object, "type",
                                     pk_struct_type_object);
  PK_MI_CHECK (errmsg, err != -1, "failed to add type object to struct");

  err = json_object_object_add (pk_struct_object, "name",
                                     pk_struct_name_object);
  PK_MI_CHECK (errmsg, err != -1, "failed to add type object to struct");

  err = json_object_object_add (pk_struct_object, "fields",
                                     pk_struct_fields_object);
  PK_MI_CHECK (errmsg, err != -1, "failed to add fields object to struct");

  err = json_object_object_add (pk_struct_object, "mapping",
                                     pk_struct_mapping_object);
  PK_MI_CHECK (errmsg, err != -1, "failed to add mapping object to struct");
...
static json_object *
pk_mi_array_to_json (pk_val array, char **errmsg)
{
  struct json_object *pk_array_object, *pk_array_type_object;
  struct json_object *pk_array_mapping_object, *pk_array_elements_object;
  struct json_object *pk_array_element_object, *pk_array_element_value_object;
  struct json_object *pk_array_element_offset_object;
  pk_val tmp;
  int err;
  ...
  for  (size_t i = 0 ; i < pk_uint_value (pk_array_nelem (array)) ; i++)
    {
      ...
      tmp = pk_array_elem_val (array, i);
      pk_array_element_value_object = pk_mi_val_to_json_1 (tmp, errmsg);
      tmp = pk_array_elem_boffset (array, i);
      pk_array_element_offset_object = pk_mi_val_to_json_1 (tmp, errmsg);

      pk_array_element_object = json_object_new_object ();

      err = json_object_object_add (pk_array_element_object, "value",
                                         pk_array_element_value_object);
      PK_MI_CHECK (errmsg, err != -1, "json_object_object_add () failed");

      err = json_object_object_add (pk_array_element_object, "offset",
  ...
  pk_array_mapping_object = pk_val_mapped_p (array) ?
                            pk_mi_mapping_to_json (array, errmsg) :
                            pk_mi_null_to_json (errmsg);

  if (pk_array_mapping_object == NULL) goto error;

  /* Everything is built on this point.
     Fill the properties of the array object.  */
  PK_MI_CHECK (errmsg,
               json_object_object_add (pk_array_object, "type",
                                      pk_array_type_object) != -1,
               "json_object_object_add () failed");
  PK_MI_CHECK (errmsg,
               json_object_object_add (pk_array_object, "elements",
                                      pk_array_elements_object) != -1,
               "json_object_object_add () failed");
  PK_MI_CHECK (errmsg,
               json_object_object_add (pk_array_object, "mapping",
                                      pk_array_mapping_object) != -1,
               "json_object_object_add () failed");
...
pk_mi_val_to_json (pk_val val, char **errmsg)
{
  ...
  err = json_object_object_add (pk_object, "PokeValue", pk_val_object);
  PK_MI_CHECK (errmsg, err != -1,
               "json_object_object_add () failed");
...
static int pk_mi_json_to_struct (pk_val *pk_struct, struct json_object *sct_obj,
                                 char **errmsg);
static int pk_mi_json_to_array (pk_val *pk_array, struct json_object *array_obj,
                                char **errmsg);

static const char *
pk_mi_json_poke_value_type (struct json_object *obj)
{
...
static int
pk_mi_json_to_int (pk_val *pk_int, struct json_object *int_obj, char **errmsg)
{
...
static int
pk_mi_json_to_uint (pk_val *pk_uint, struct json_object *uint_obj,
                    char **errmsg)
{
  struct json_object *value_object, *size_object;
  uint64_t value;
...
static int
pk_mi_json_to_string (pk_val *pk_string, struct json_object *str_obj,
                      char **errmsg)
{
...
static int
pk_mi_json_to_offset (pk_val *pk_offset, struct json_object *offset_obj,
                      char **errmsg)
{
  ...
  err = pk_mi_json_to_uint (&magnitude, magnitude_object, errmsg);
  PK_MI_CHECK (errmsg, err != -1, "pk_mi_json_to_uint failed");
...
static int
pk_mi_json_to_mapping (pk_val *poke_value, struct json_object *obj,
                       char **errmsg)
{
  /* TODO: write me.  */
  return 0;
...
int
pk_mi_json_to_val_1 (pk_val *poke_value, struct json_object *obj,
                     char **errmsg)
{
  ...
  if (!strncmp (poke_object_type, "\"Integer\"", strlen ("\"Integer\"")))
    ...
    {
      if (pk_mi_json_to_struct (poke_value, obj, errmsg) == -1)
        goto error;
    }
...
static int
pk_mi_json_to_struct (pk_val *pk_struct, struct json_object *sct_obj,
                      char **errmsg)
{
  /* To build a pk_struct, we need its fields, its name and its mapping.  */
  struct json_object *array_object, *fields_object, *search_object;
  pk_val mapping, sct_type, sct_field_name, sct_field_value, sct_field_offset;
      ...
      for (size_t i = 0 ; i < fields_len ; i++)
        {
          ...
          err = json_object_object_get_ex (array_object, "offset",
                                           &search_object);
          PK_MI_CHECK (errmsg, err != 0,
                       "json type %s does not contain key \"offset\"",
                       pk_mi_json_poke_value_type (array_object));

          if (pk_mi_json_to_val_1 (&sct_field_offset, search_object, errmsg) == -1)
            goto error;
...
static pk_val *
pk_mi_json_array_element_pair (struct json_object *elements_object, size_t idx,
                               char **errmsg)
{
  ...
  err = json_object_object_get_ex (element_object, "offset", &search_object);
  PK_MI_CHECK (errmsg, err != 0,
              "json type %s does not contain key \"offset\"",
              pk_mi_json_poke_value_type (element_object));
...
static int
pk_mi_json_to_array (pk_val *pk_array, struct json_object *array_obj,
                     char **errmsg)
{
...
int
pk_mi_json_to_val (pk_val *value, const char *poke_object_str, char **errmsg)
{
  ...
  do
    {
      poke_object = json_tokener_parse_ex (tok, poke_object_str,
                                           strlen (poke_object_str));
    }
  ...
  if (pk_mi_json_to_val_1(value, search_object, errmsg) == -1) goto error;
